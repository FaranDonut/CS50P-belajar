...
> * Contoh: David menunjukkan bagaimana fungsi dapat melakukan perhitungan (seperti pemangkatan) dan mengirim hasilnya kembali ke pemanggil fungsi tersebut.
> * Penyelesaian masalah: Di akhir segmen, David mendemonstrasikan bahwa ada banyak cara untuk menyelesaikan masalah yang sama, misalnya menggunakan operator ** untuk pemangkatan atau menggunakan fungsi bawaan pow().
