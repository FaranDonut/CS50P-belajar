...
print("before,",temen)
temen = temen.strip().title() #-> fungsi .strip() untuk menghilangkan white space (blank dari spasi) dan .title() untuk menjadikan setiap kata memiliki hurf besar seperti judul buku/nama orang/ kota dll
print("after,",temen)
